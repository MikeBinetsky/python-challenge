...
* [DONE] Create a new repository for this project called `python-challenge`. **Do not add this homework to an existing repository**.
...
* Inside of each folder that you just created, add the following:
  ...
  * [DONE] An "analysis" folder that contains your text file that has the results from your analysis.

* [DONE]Push the above changes to GitHub or GitLab.
